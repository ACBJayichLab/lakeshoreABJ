...
ltspm3/                      LTSPM3 ONLY -- imports lschart, never the reverse
  ...
  fitted_response.py Same seam, driven by the ODE fitted to the 43 h sweep:
                     ...
                     from under a second at 10 K to 489 s at 110 K and the
                     steady state is the measured one. Stdlib only -- the curves
                     come frozen in _fitted_table.py (GENERATED by
