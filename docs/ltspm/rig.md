...
limit forcing slower polling on long runs, not a rig constraint.
...
unless it is explicitly enabled. On this rig, leave it that way.
...
## The other two rigs in this repo, for contrast
