"""Measure the plant the only way that actually works: step it and watch.
...
pinned island, and heating it off a 300 K coldplate is a different plant from
...
def run_simulated(points: list[float], *, step_pct: float = 0.5,
    ...
    for base in points:
        ...
        settled = rig.plant.p.steady_state(base) - rig.plant.p.t_bath
        rig.plant._fast = rig.plant._slow = settled
        sim.analog_pct = base
